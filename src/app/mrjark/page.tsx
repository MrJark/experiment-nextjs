...
export default function Mrjark() {
  return (
    <main className="flex flex-col min-h-screen w-screen items-center justify-between p-24">
      <div className="flex flex-col justify-center items-center w-2/3 h-80 bg-yellow-500 rounded-3xl shadow-lg shadow-yellow-400">
        <Image
        ...
        <Link
          className="rounded-full text-yellow-300 italic bg-yellow-900 cursor-pointer px-6 py-1 transition-all duration-300 hover:scale-105 hover:shadow-sm hover:shadow-yellow-200"
          href="/"
        >
          Go Back
        </Link>
